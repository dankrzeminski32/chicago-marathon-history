...
@pytest.mark.parametrize("input, output", [("2012",{"id":9.0,"num_athletes":37505.0,"num_athletes_female":16792.0,"num_athletes_male":20681.0,"year":2012.0}),("2030", {"Error":"Invalid year, please try again."})])
